...
function CustomerDetailsDialog({ open, onOpenChange, sales, salesLoading, selectedCustomer, setDetailOpen, setSelectedCustomer }: any) {
  return (
    ...
    <LayoutShell shopId={shopId}>
      <div className="space-y-6 animate-in fade-in duration-500">
        ...
        <CustomerDetailsDialog
          open={detailOpen}
          onOpenChange={(v: boolean) => { if (!v) setSelectedCustomer(null); setDetailOpen(v); }}
          sales={sales}
